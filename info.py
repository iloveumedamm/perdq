...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5791145987 5764988016').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001918999034 -1001869131551 -1001675532390').split()]
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001806978974')
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/streaamdb')
...
PROTECT_CONTENT = is_enabled((environ.get('PROTECT_CONTENT', "0")), False)
